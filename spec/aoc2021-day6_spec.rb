...
RSpec.describe Aoc2021::Day6 do

  it "solves part 1 example 1" do
    day = Aoc2021::Day6.new ::File.expand_path("../input/2021/day6/input1-example", __dir__)
  ...
  it "solves part 1" do
    day = Aoc2021::Day6.new ::File.expand_path("../input/2021/day6/input1", __dir__)
